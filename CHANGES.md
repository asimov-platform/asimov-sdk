...
## 25.5.0 - 2026-09-21
### Added
- New crates: asimov-keyring, asimov-remote, asimov-social
### Changed
- API enhancements for asimov-runner and asimov-patterns

## 25.4.0 - 2026-09-10
### Added
- Add the Matcher program pattern and runner (@SamuelSarle)
### Changed
- Rename the `catalog` operation to `list` (@SamuelSarle)
...
- Add support for model dependencies. (#40 by @SamuelSarle)
